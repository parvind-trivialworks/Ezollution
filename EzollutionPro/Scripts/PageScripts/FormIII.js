...
function GetSchedulingData() {
    schedulerTable = $('#tblScheduler').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "iSchedulingId", orderable: false, render: function (data) {
                    return "<button onclick=\"location.href='/FormIII/DownloadFormIIIData?iSchedulingId=" + data + "'\" class='btn btn-primary'> Form III</button>";
                }
            }
        ],
    });
