...
function googleTranslateElementInit() {
    new google.translate.TranslateElement({ pageLanguage: 'en', includedLanguages: 'th,en,ar', layout: google.translate.TranslateElement.InlineLayout.SIMPLE }, 'google_translate_element');
}
$('html').click(function () {
    $('.goog-te-banner-frame:first').hide();
    $('body').css('top', '0px');
});
