...
function GetSchedulingData() {
    schedulerTable = $('#tblScheduler').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "sMAWBNo", "orderable": false, render: function (data, type, row, meta) {
                    if (row.bIsTransmitted)
                        return data;
                    return "<a href=\"/MAWB/ViewMAWB?iMAWBId=" + row.iMAWBId + "\"'>" + data + "</a>";
                }
            },
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    if (row.bIsScheduled)
                        html += " <button class='btn btn-success btn-xs' onclick='ProceedToTransmit(" + data + ")'><i class='fa fa-rss'></i> Proceed to Transmit</button>";
                    return html;
                }
            },
        ],
